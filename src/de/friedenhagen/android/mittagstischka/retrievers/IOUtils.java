...
public final class IOUtils {
    ...
    /**
     * Converts the given String to a byte array using UTF-8 decoding.
     * This just rethrows the {@link UnsupportedEncodingException} as
     * a {@link RuntimeException}, which really should never happen, as
     * UTF-8 is always included in the  JDK.
     * 
    ...
    /**
     * Converts the given byte array to a String using UTF-8 encoding.
     * This just rethrows the {@link UnsupportedEncodingException} as
     * a {@link RuntimeException}, which really should never happen, as
     * UTF-8 is always included in the  JDK.
     * 
